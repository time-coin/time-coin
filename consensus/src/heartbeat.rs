    ...
    pub async fn finalize_sync(&self, expected_nodes: usize) -> SyncStatus {
        ...
        if self.check_sync_complete(expected_nodes).await {
            ...
            *status = SyncStatus::Synchronized;
            ...
            println!(
                "   - Agreement: {}/{} nodes ({:.1}%)",
                agreement.agreement_count, agreement.total_nodes, agreement.agreement_percentage
            );
...
mod tests {
    ...
    async fn test_chain_agreement_unanimous() {
        ...
        manager
            .register_heartbeat(create_heartbeat("node1", 100, "hash_abc"))
            .await
            .unwrap();
        manager
            .register_heartbeat(create_heartbeat("node2", 100, "hash_abc"))
            .await
            .unwrap();
        manager
            .register_heartbeat(create_heartbeat("node3", 100, "hash_abc"))
            .await
            .unwrap();
    ...
    async fn test_chain_agreement_majority() {
        ...
        manager
            ...
            .unwrap();
        manager
            .register_heartbeat(create_heartbeat("node4", 99, "hash_xyz"))
            .await
            .unwrap();
    ...
    async fn test_get_synchronized_nodes() {
        ...
        manager
            ...
            .unwrap();
        manager
            .register_heartbeat(create_heartbeat("node3", 99, "hash_xyz"))
            .await
            .unwrap();
