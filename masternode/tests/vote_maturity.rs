...
use time_masternode::{
    status::{MasternodeStatus, SyncStatus, VoteMaturityConfig},
    CollateralTier,
};
...
fn test_vote_maturity_enforcement_professional_tier() {
    ...
    assert!(
        !mn_status.can_vote_at_height(109, &tier),
    ...
    assert!(
        mn_status.can_vote_at_height(110, &tier),
