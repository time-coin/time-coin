...
impl MasternodeConfigEntry {
    ...
    pub fn parse_line(line: &str, line_num: usize) -> Result<Self, MasternodeConfigError> {
        ...
        let collateral_output_index = parts[4].parse::<u32>().map_err(|_| {
...
impl MasternodeConfig {
    ...
    pub fn save_to_file<P: AsRef<Path>>(&self, path: P) -> Result<(), MasternodeConfigError> {
        ...
        content.push_str("# Format: alias IP:port masternodeprivkey collateral_txid collateral_output_index\n");
        content.push_str("#\n");
...
mod tests {
    ...
    fn test_parse_valid_line() {
        ...
        assert_eq!(entry.masternode_privkey, "93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg");
        assert_eq!(entry.collateral_txid, "2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c");
    ...
    fn test_config_add_entry() {
        ...
        let entry = MasternodeConfigEntry {
            ...
            collateral_txid: "2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c".to_string(),
