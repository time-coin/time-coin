#!/bin/bash
# Create a proper testnet.toml config for the server with absolute paths
...
echo "Creating config file with absolute paths at: $CONFIG_FILE"
...
echo "✅ Config file created with absolute paths"
echo ""
echo "Config file location: $CONFIG_FILE"
echo ""
echo "Now update the service file to use this config:"
echo "  ExecStart=/usr/local/bin/timed --config $CONFIG_FILE"
