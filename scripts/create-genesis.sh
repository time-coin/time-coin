...
echo ""
echo "NOTE: Update your testnet.toml config to point to this genesis file:"
echo "  [blockchain]"
echo "  genesis_file = \"$GENESIS_FILE\""
echo ""
echo "Or use absolute path like:"
echo "  genesis_file = \"/root/time-coin-node/config/genesis-testnet.json\""
