...
Quick navigation to all TIME Coin technical documentation.
...
- **[block-rewards.md](block-rewards.md)** - Block reward distribution
- **[transaction-fees.md](transaction-fees.md)** - Fee structure
- **[GOVERNANCE](governance/)** - Governance system documentation
- **[TREASURY](treasury/)** - Treasury system documentation

## 🔧 Development & Operations

- **[BUILDING.md](BUILDING.md)** - Build instructions
- **[RUNNING_MASTERNODE.md](RUNNING_MASTERNODE.md)** - Masternode setup
- **[CONTRIBUTING.md](CONTRIBUTING.md)** - Contribution guidelines
- **[TODO.md](TODO.md)** - Development roadmap

## 📊 Whitepapers

- **[whitepaper/Technical-Whitepaper-v3.0.md](whitepaper/Technical-Whitepaper-v3.0.md)** - Technical whitepaper
- **[whitepaper/TIME-Technical-Whitepaper.md](whitepaper/TIME-Technical-Whitepaper.md)** - Utility token model
- **[whitepaper/Security-Whitepaper-V3.0.md](whitepaper/Security-Whitepaper-V3.0.md)** - Security analysis
